...
// TELETEXT
    ...
    Route::get('/teletext/channels/{id}', [TeletextController::class, 'channel']);
    ...
    Route::get('/new-comments', [CommentsController::class, 'latest']);
...
//USERS
    ...
    Route::get('/index/34-{id}', [CommentsController::class, 'user']);
    Route::get('/users/{id}/comments', [CommentsController::class, 'user']);
