...
$(body).on('click', '*[data-confirm-form-url]', function() {
   let text = $(this).data('confirm-form-title') || "Вы уверены?";
   let url = $(this).data('confirm-form-url');
   let input_name = $(this).data('confirm-form-input-name');
   let input_value = $(this).data('confirm-form-input-value');
   $(body).append(`<div id="confirm_form">
   ...
   showModal('#confirm_form', 'Подтверждение');
});
