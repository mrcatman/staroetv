...
Vue.component('video-cutter', require('./components/VideoCutter.vue').default);
Vue.component('history-event-editor', require('./components/HistoryEventEditor.vue').default);
Vue.component('additional-channels-editor', require('./components/AdditionalChannelsEditor.vue').default);
Vue.component('mass-uploader', require('./components/MassUploader.vue').default);
Vue.component('regional-channels-list', require('./components/RegionalChannelsList.vue').default);
...
Vue.component('categories-manager', require('./components/admin/CategoriesManager.vue').default);
