...
@section('content')
    <div class="forum-page forum-page--form">
                ...
                <div class="forum__top-panel">
                    <div class="forum__top-panel__inner">
                        <div class="forum-section__breadcrumbs">
                            ...
                            @if ($parent)
                                <a class="forum-section__breadcrumb" href="{{route('forum.subforums.show', $parent)}}">{{$parent->title}}</a>
                            @endif
                            @if ($forum)
            ...
            <form class="form box" action="{{$forum ? route('forum.subforums.save', $forum) : route('forum.subforums.create')}}" method="POST">
