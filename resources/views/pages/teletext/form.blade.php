    ...
    <form enctype="multipart/form-data" class="form box box--top" method="POST">
        <div class="box__heading">
            ...
            <div class="box__heading__right">
                <a href="/teletext" class="button button--light">Назад</a>
            </div>
        </div>
        <div class="box__inner">
            ...
            <div class="input-container">
                ...
                <div class="input-container__inner">
                    <div class="input-container__element-outer">
                        <div class="radio-buttons radio-buttons--quality">
                            @for ($i = 1; $i <= 10;$i++)
                                <label class="radio-button radio-button--quality">
                                    <input type="radio" name="quality"
                                           @if (($teletext && $teletext->quality == $i) || (!$teletext && $i === 7)) checked="checked" @endif value={{$i}} />
                                    <div class="radio-button--quality__variant">{{$i}}</div>
                                </label>
                            @endfor
                        </div>
                    </div>
