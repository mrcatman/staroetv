    ...
    <div class="col">
        ...
        @foreach($programs as $programs_list)
            <div class="box">
                <div class="box__heading">
                    <div class="box__heading__inner">
                        {{$programs_list[0]->channel->name}} @if ($programs_list[0]->channel->is_abroad)
                            ({{$programs_list[0]->channel->country}})
                        @endif @if ($programs_list[0]->channel->is_regional)
                            ({{$programs_list[0]->channel->city}})
                        @endif
                    </div>
                </div>
