    ...
    <form class="form box" action="{{$article ? "/articles/edit/".$article->id : "/articles/add"}}" method="POST">
        ...
        <div class="box__inner">
                ...
                <div class="input-container">
                    ...
                    <div class="input-container__inner">
                        <div class="input-container__element-outer">
                            <textarea class="input" name="signature">{{$article ? $article->short_content : ""}}</textarea>
                            <span class="input-container__message"></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="input-container">
                ...
                <div class="input-container__inner">
                    <picture-uploader name="cover_id" :data="{{$article && $article->cover ? $article->cover : "null"}}" />
                    <span class="input-container__message"></span>
                </div>
            </div>
            <div class="input-container">
