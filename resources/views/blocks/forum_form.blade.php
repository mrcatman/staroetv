<form class="form bb-editor @if (isset($inline) && $inline) bb-editor--inline @endif" data-callback="forumMessageCallback" @if (isset($edit_id)) action="/forum/edit-message" @else  action="/forum/post-message" @endif method="POST" data-reset="1" data-auto-close-modal="1">
    ...
    <div class="bb-editor__submit">
        <input class="button bb-editor__submit__button" type="submit" name="submit" value="{{isset($edit_id) ? "Сохранить" : "Отправить"}}">
        @if (isset($edit_id))
