<div class="bb-editor__inner">
    ...
    <span class="bb-editor__input-container">
        <input type="button" title="Italic" value="i" onclick="bb.simpletag('i','','','')" class="codeButtons" id="i"
               style="width:20px;font-style:italic">
    </span>
    <span class="bb-editor__input-container">
        <input type="button" title="Underline" value="u" onclick="bb.simpletag('u','','','')" class="codeButtons" id="u"
               style="width:20px;text-decoration:underline">
    </span>
    <span class="bb-editor__input-container">
    ...
    <span class="bb-editor__input-container">
        <select id="ffont" class="codeButtons"
                onchange="bb.alterfont(this.options[this.selectedIndex].value, 'font','message','');this.selectedIndex=0;">
    ...
    <span class="bb-editor__input-container">
        <input type="button" title="URL" value="https://" onclick="bb.tag_url()" class="codeButtons"
               style="direction:ltr;width:45px;" id="url">
    </span>
    <span class="bb-editor__input-container">
        <input type="button" title="E-mail" value="@" onclick="bb.tag_email()" class="codeButtons" style="width:30px;"
               id="email">
    </span>
    <span class="bb-editor__input-container">
        <input type="button" title="Image" value="img" onclick="bb.tag_image()" class="codeButtons" style="width:35px;"
               id="img">
    </span>

    @if (isset($forum) && $forum)
        <span class="bb-editor__input-container">
            <input type="button" title="Quote" value="quote" onclick="bb.simpletag('quote','','','')" class="codeButtons"
                   style="width:40px;" id="quote"/>
        </span>

        <span class="bb-editor__input-container">
            <input type="button" title="Spoiler" value="spoiler" onclick="bb.simpletag('spoiler','','','')"
                   class="codeButtons" style="width:40px;" id="spoiler"/>
        </span>
    @endif

    <span class="bb-editor__input-container">
        <input type="button" title="Code" value="code" onclick="bb.simpletag('code','','','')" class="codeButtons"
               style="width:40px;" id="codes"/>
    </span>
    ...
    <span class="bb-editor__input-container">
        <input type="button" align="top" value="video" onclick="bb.simpletag('video','','',''); " class="codeButtons"
               title="video" name="hide"/>
    </span>
    <!--
<span class="bb-editor__input-container">
...
-->
    ...
    <div class="bb-editor__text-container">
        <textarea class="bb-editor__text" rows="8" name="{{isset($name) ? $name : 'message'}}" id="message" cols="93">@if (isset($content)){{$content}}@endif</textarea>
    ...
    @if (!isset($show_buttons) || $show_buttons)
        <div class="bb-editor__submit">
            <input class="button bb-editor__submit__button" type="submit" name="submit"
                   value="{{isset($edit_id) ? "Сохранить" : "Отправить"}}">
            @if (isset($edit_id))
                <a class="button bb-editor__cancel">Отменить</a>
            @endif
