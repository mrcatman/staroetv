    ...
    <div class="box box--top teletext-controls">
        ...
        <div class="box__inner">
            <div class="teletext-controls__inner">
                <a href="?page={{$navigation['prev']}}"
                   class="button button--light teletext-controls__button teletext-controls__prev">
                    <<
                </a>
                ...
                <a href="?page={{$navigation['next']}}"
                   class="button button--light teletext-controls__button teletext-controls__next">
                    >>
                </a>
            </div>
