...
class importForum extends Command
{
    ...
    public function handle()
    {
        if (false) {
            ...
            $sections = CSVHelper::transform(public_path("data_new/fr_fr.txt"), [
            ...
            $topics = CSVHelper::transform(public_path("data_new/forum.txt"), [
            ...
            foreach ($topics as $topic) {
                ...
                if ($last_reply_at > 0) {
                    ...
                    $topic_obj = ForumTopic::find($topic['id']);
                    if (!$topic_obj) {
        ...
        foreach ($messages as $message) {
           //if ($message['id'] > 157097) {
                ...
                $message_obj = ForumMessage::find($message['id']);
                if (!$message_obj) {
