...
class Forum extends Model {
    ...
    public function subforums() {
        return $this->hasMany('App\Models\Forum', 'parent_id', 'id');
    }
    ...
    public function fixed_topics() {
        return $this->hasMany('App\Models\ForumTopic', 'forum_id', 'id')->orderBy('last_reply_at', 'DESC')->where(['is_fixed' => 1]);
    }

    public function not_fixed_topics() {
        return $this->hasMany('App\Models\ForumTopic', 'forum_id', 'id')->orderBy('last_reply_at', 'DESC')->where(['is_fixed' => 0]);
    }
