...
class InterprogramPackage extends Model {
    ...
    public function pictures() {
        return $this->hasMany('App\Models\InterprogramPackagePicture', 'package_id', 'id');
    }

    public function records() {
        return $this->hasMany('App\Models\Record', 'interprogram_package_id', 'id')->orderBy('internal_order', 'ASC');
    }

    public function annotations() {
        return $this->hasMany('App\Models\Annotation', 'interprogram_package_id', 'id')->orderBy('order', 'ASC');
    }
    ...
    public function visibleRecords() {
        return $this->hasMany('App\Models\Record', 'interprogram_package_id', 'id')->orderBy('internal_order', 'ASC')->where(['is_selected' => true]);
    }
