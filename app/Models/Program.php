...
class Program extends Model {
    ...
    public function getCanEditAttribute() {
        ...
        return auth()->user() && $this->author_id == auth()->user()->id && PermissionsHelper::allows("programsown");
    }
    ...
    public function design() {
        return $this->hasMany('App\Models\Record')->where(['is_interprogram' => true, 'program_id' => $this->id]);
    }

    public function additionalChannels() {
        return $this->hasMany(AdditionalChannel::class);
    }
